...
- 【换课】换课快捷方式：如果今天没有课程，则选择临时课表
- 【组件】分割线组件 ([#278](https://github.com/ClassIsland/ClassIsland/issues/278))
- 【课表组件】通过附加设置指定仅显示当前课程设置 ([#289](https://github.com/ClassIsland/ClassIsland/issues/289))
- 【UI】优化人机交互
- 【UI】允许禁用过渡动画和动画等待
- 【应用设置】优化关于界面
- 【应用】优化检测桌面文件夹跳过逻辑
