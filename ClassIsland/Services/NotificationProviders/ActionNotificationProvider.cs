...
public class ActionNotificationProvider : INotificationProvider, IHostedService
{
    ...
    private void ActionHandler(object? o, string guid)
    {
        ...
        NotificationHostService.ShowNotification(new NotificationRequest()
        {
            ...
            OverlayContent = new TextBlock(new Run(settings.Content)) { FontSize = 18, HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center},
