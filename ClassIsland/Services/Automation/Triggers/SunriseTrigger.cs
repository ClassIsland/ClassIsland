...
public class SunriseTrigger : TriggerBase
{
    ...
    ILogger<SunriseTrigger> Logger { get; } = App.GetService<ILogger<SunriseTrigger>>();
    ...
    private void ScheduleNext()
    {
        ...
        if (!TryGetSunrise(now, out var sunrise))
            return;
    ...
    private bool TryGetSunrise(DateTimeOffset now, out DateTimeOffset sunrise)
    {
        sunrise = default;
