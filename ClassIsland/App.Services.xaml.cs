...
public partial class App
{
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddRule<CurrentWeatherRuleSettings, CurrentWeatherRuleSettingsControl>("classisland.weather.currentWeather", "当前天气是", "\uE4DC").WithContributorInfo("@wrc @laoshui");
        services.AddRule<CurrentWeatherRuleSettings, CurrentWeatherRuleSettingsControl>("classisland.weather.tomorrowWeather", "明天天气是", "\uE4DC").WithContributorInfo("@wrc @laoshui");
