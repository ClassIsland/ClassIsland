...
public class ExcelSelectionTextBox : TextBox
{
    ...
    {
        get => (RangePosition)GetValue(ValueProperty);
        set => SetValue(ValueProperty, value);
    }

    public static readonly DependencyProperty EnterSelectingModeCommandProperty = DependencyProperty.Register(
        nameof(EnterSelectingModeCommand), typeof(ICommand), typeof(ExcelSelectionTextBox),
        new PropertyMetadata(default(ICommand)));

    public ICommand EnterSelectingModeCommand
    {
        get => (ICommand)GetValue(EnterSelectingModeCommandProperty);
    ...
    public static readonly DependencyProperty SelectionPropertyNameProperty = DependencyProperty.Register(
        nameof(SelectionPropertyName), typeof(string), typeof(ExcelSelectionTextBox),
        new PropertyMetadata(default(string)));

    public string SelectionPropertyName
    {
        get => (string)GetValue(SelectionPropertyNameProperty);
    ...
    {
        get => (bool)GetValue(IsCurrentSelectingProperty);
        set => SetValue(IsCurrentSelectingProperty, value);
    }

    static ExcelSelectionTextBox()
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(ExcelSelectionTextBox),
            new FrameworkPropertyMetadata(typeof(ExcelSelectionTextBox)));
    }
