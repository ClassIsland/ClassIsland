...
/// </summary>
public partial class ClassPreparingNotificationProviderSettingsControl : UserControl
{
    public ClassPreparingNotificationSettings Settings
    {
        get;
        set;
    }

    public ClassPreparingNotificationProviderSettingsControl(ClassPreparingNotificationSettings settings)
    {
        Settings = settings;
        InitializeComponent();
    }
