...
# build
if ($isReleaseSigning) {
    msbuild .\ClassIsland.Packaging\ClassIsland.Packaging.wapproj /p:Configuration=Release_MSIX /p:UapAppxPackageBuildMode=SideloadOnly /p:AppxBundle=Never /p:GenerateAppxPackageOnBuild=true /p:AppxPackageDir="Packages" /p:RuntimeIdentifiers="win-x64" /p:Platform="x64" /p:PlatformTarget="x64" /p:PublishBuilding=true /p:msbuild .\ClassIsland.Packaging\ClassIsland.Packaging.wapproj /p:Configuration=Release_MSIX /p:UapAppxPackageBuildMode=SideloadOnly /p:AppxBundle=Never /p:PackageCertificateKeyFile=TestSigningKey.pfx /p:PackageCertificatePassword="" /p:GenerateAppxPackageOnBuild=true /p:AppxPackageDir="Packages" /p:RuntimeIdentifiers="win-x64" /p:Platform="x64" /p:PlatformTarget="x64" /p:PublishBuilding=true /p:AppxPackageSigningEnabled=false
} else {
