...
public static class TriggerRegistryExtensions
{
    ...
    /// <param name="services"><see cref="IServiceCollection"/> 对象</param>
    /// <returns>原来的 <see cref="IServiceCollection"/> 对象</returns>
    public static IServiceCollection AddTrigger<TTrigger, TSettings>(this IServiceCollection services)
        where TTrigger : TriggerBase where TSettings : TriggerSettingsControlBase
    {
